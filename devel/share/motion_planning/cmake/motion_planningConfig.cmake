...
if("TRUE" STREQUAL "TRUE")
  set(motion_planning_SOURCE_PREFIX /home/zejian/catkin_ws/src/motion_planning)
  set(motion_planning_DEVEL_PREFIX /home/zejian/catkin_ws/devel)
  ...
  set(motion_planning_INSTALL_PREFIX /home/zejian/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'motion_planning' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'JayZejianZhou <JayZejianZhou@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'motion_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zejian/catkin_ws/src/motion_planning/${idir}'.  Ask the maintainer 'JayZejianZhou <JayZejianZhou@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${motion_planning_dep}_FOUND)
      find_package(${motion_planning_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${motion_planning_dep} REQUIRED ${depend_list})
  endif()
